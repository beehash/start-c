...
int main() {
  ...
  node1 = revertLNode(node1);
  // printf("%.f\n", book7.price);
  printf("%.f, %.f, %.f, %.f", node1->data.price, node1->next->data.price, node1->next->next->data.price, node1->next->next->next->data.price);
